...
class ChatBot(object):
    ...
    def __init__(self):
        ...
        self.target_word2idx = np.load(
            'support files/target-word2idx.npy', allow_pickle=True).item()
        self.target_idx2word = np.load(
            'support files/target-idx2word.npy', allow_pickle=True).item()
        context = np.load('support files/word-glove-context.npy', allow_pickle=True).item()
